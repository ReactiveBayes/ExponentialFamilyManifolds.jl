"""
    get_natural_manifold_base(::Type{GammaInverse}, ::Tuple{}, conditioner=nothing)

Get the natural manifold base for the `GammaInverse` distribution.
"""
...
Converts the `point` to a compatible representation for the natural manifold of type `GammaInverse`.
"""
